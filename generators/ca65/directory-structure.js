...
function createConfig(game, directory) {
    ...
    let neededDirs = ['config', 'source', 'source/assembly', 'graphics', 'rom', 'tools', 'tools/emulators', 'temp'];
    if (game.useTutorial) {
        neededDirs = ['config', 'source', 'source/assembly', 'rom', 'tools', 'tools/emulators', 'temp'];
    }
