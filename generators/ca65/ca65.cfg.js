...
function createConfig(game, directory) {
    ...
    fs.writeFileSync(path.join(directory, 'cfg', 'ca65.cfg'), eta.render(fs.readFileSync(path.join(__dirname, 'ca65.template.cfg')).toString(), {game, mapper}, {autoTrim: false}));
}
